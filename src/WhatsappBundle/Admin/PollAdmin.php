...
//            ->add('questionPoll', null, array('label' => 'Categoría'))
...
//            ->add('configuration', null, array('label' => 'Empresa'))
        ;
             $formMapper
//                     ->add('questionPoll', 'sonata_type_admin', array('label' => false, 'required' => false,))
                ->add('questionPolls', 'sonata_type_collection', array(
                    'required'      => false,
                    'label'         => 'Preguntas',   
                    'btn_add'       => 'Agregar pregunta',
                    'by_reference' => false,
                    'type_options'  => array(
                        'delete' => true,
                    ),
...
//            ->add('configuration', "text", array('label' => 'Empresa'))
            ...
            ->add('questionPolls', null, array('label' => 'Preguntas', 'route' => array('name' => '')))            
        ;
        $listMapper
