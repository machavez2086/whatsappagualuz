...
class ObleaRetiroAdmin extends Admin
{
...
//            $this->trans('export.name') => 'name',
            ...
            $this->trans('export.destinatarioNames') => 'destinatarioNames',
            $this->trans('export.destinatarioEmails') => 'destinatarioEmails',
            $this->trans('export.destinatarioPhones') => 'destinatarioPhones',
            $this->trans('export.cantPaquetesRetirar') => 'cantPaquetesRetirar',
...
// Fields to be shown on create/edit forms
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ...
            ->add('destinatarioNames', null, array('label' => 'Nombres de destinatario'))
            ->add('destinatarioEmails', null, array('label' => 'Emails de destinatario'))
            ->add('destinatarioPhones', null, array('label' => 'Teléfonos de destinatario'))
...
//                'show' => array(),                
                ...
                'delete' => array(),
                'preview' => array(
                    'template' => 'WhatsappBundle:SHOP:list__action_ticket_oblea_retiro_print_preview.html.twig'
                ),
                'print' => array(
                    'template' => 'WhatsappBundle:SHOP:list__action_ticket_oblea_retiro_print.html.twig'
                ),
                'xls' => array(
                    'template' => 'WhatsappBundle:SHOP:list__action_ticket_oblea_retiro_export_xls.html.twig'
                ),
