    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        if($subject != null){
            if($subject->getId() != null){
                $formMapper->add('name', null, array('label' => 'Nombre', 'required' => true,"read_only"=>true));
            }
        }
    
        $formMapper
            ->add('fileType', 'choice', array('label' => 'Tipo de fichero', 'required' => true, 
                'choices' => array("Sonido" => "Sonido", "Imagen" => "Imagen", "Video" => "Video")
                ))
...
////                    'show_filter' => true
//                ))
            ->add('media', null, array('label' => 'Fichero'))    
