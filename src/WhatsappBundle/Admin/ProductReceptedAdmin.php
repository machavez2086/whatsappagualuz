...
class ProductReceptedAdmin extends Admin
{
...
//            $this->trans('export.configuration') => 'configuration',
            $this->trans('export.recivedAt') => 'recivedAt',
            $this->trans('export.description') => 'description',
...
// Fields to be shown on create/edit forms
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ->add('recivedAt', null, array('label' => 'Fecha de recibido'))
...
//            ->add('configuration', "text", array('label' => 'Empresa'))
            ->addIdentifier('recivedAt', null, array('label' => 'Fecha de recibido'))            
            ->add('description', null, array('label' => 'Descripción'))
            ->add('peticion', null, array('label' => 'Ticket'))
        ;
        $listMapper
