...
/**
 * @ORM\Entity(repositoryClass="WhatsappBundle\Repository\ElementTypeRepository")
...
class ElementType
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Peticion", mappedBy="elementType", cascade={"persist"}, fetch="EXTRA_LAZY", orphanRemoval=false)
     */
    private $peticions;
    ...
    /** 
    * @ORM\ManyToOne(targetEntity="WhatsappBundle\Entity\Configuration", inversedBy="elementTypes")
