...
/**
 * @ORM\Entity(repositoryClass="WhatsappBundle\Repository\ClientActitudRepository")
 * @ORM\Table(name="clientactitud")
 */
class ClientActitud
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Peticion", mappedBy="clientActitud", cascade={"persist"}, fetch="EXTRA_LAZY", orphanRemoval=false)
     */
    private $peticions;
    ...
    {
        $peticion->setClientActitud($this);
    ...
    /** 
    * @ORM\ManyToOne(targetEntity="WhatsappBundle\Entity\Configuration", inversedBy="clientActituds")
