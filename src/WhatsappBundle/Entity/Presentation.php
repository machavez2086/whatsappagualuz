...
/**
 * @ORM\Entity(repositoryClass="WhatsappBundle\Repository\PresentationRepository")
...
class Presentation
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Peticion", mappedBy="presentation", cascade={"persist"}, fetch="EXTRA_LAZY", orphanRemoval=false)
     */
    private $peticions;
    ...
    /** 
    * @ORM\ManyToOne(targetEntity="WhatsappBundle\Entity\Configuration", inversedBy="presentations")
