...
/**
 * @ORM\Entity(repositoryClass="WhatsappBundle\Repository\PeticionStatusRepository")
 * @ORM\Table(name="peticionstatus")
 */
class PeticionStatus
{ 
     ...
     *
     * @ORM\OneToMany(targetEntity="Peticion", mappedBy="peticionStatus", cascade={"persist"}, fetch="EXTRA_LAZY", orphanRemoval=false)
     */
    private $peticions;
    ...
    {
        $peticion->setPeticionStatus($this);
    ...
    /** 
    * @ORM\ManyToOne(targetEntity="WhatsappBundle\Entity\Configuration", inversedBy="peticionStatuss")
