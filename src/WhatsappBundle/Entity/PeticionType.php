...
/**
 * @ORM\Entity(repositoryClass="WhatsappBundle\Repository\PeticionTypeRepository")
 * @ORM\Table(name="peticiontype")
 */
class PeticionType
{ 
     ...
     *
     * @ORM\OneToMany(targetEntity="Peticion", mappedBy="peticionType", cascade={"persist"}, fetch="EXTRA_LAZY", orphanRemoval=false)
     */
    private $peticions;
