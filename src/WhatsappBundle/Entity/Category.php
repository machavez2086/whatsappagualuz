...
/**
 * @ORM\Entity(repositoryClass="WhatsappBundle\Repository\CategoryRepository")
...
class Category
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Peticion", mappedBy="category", cascade={"persist"}, fetch="EXTRA_LAZY", orphanRemoval=false)
     */
    private $peticions;
    ...
    /** 
    * @ORM\ManyToOne(targetEntity="WhatsappBundle\Entity\Configuration", inversedBy="categorys")
