...
class AskAndAnswersAdminTest extends AbstractTestCase
{
    /**
...
//        ));
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/askandanswers/list');
    ...
    {
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/askandanswers/create');
        $this->assertEquals(200, $client->getResponse()->getStatusCode());
