...
class ConfigurationAdminTest extends AbstractTestCase
{
    /**
...
//        ));
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/configuration/list');
    ...
    public function testNew()
    {
        $this->logIn();
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/configuration/create');
        $this->assertEquals(200, $client->getResponse()->getStatusCode());
