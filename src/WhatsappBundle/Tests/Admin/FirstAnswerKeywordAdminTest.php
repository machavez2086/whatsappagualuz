...
class FirstAnswerKeywordAdminTest extends AbstractTestCase
{
...
//        ));
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/firstanswerkeyword/list');
    ...
    public function testNew()
    {
        $this->logIn();
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/firstanswerkeyword/create');
        $this->assertEquals(200, $client->getResponse()->getStatusCode());
