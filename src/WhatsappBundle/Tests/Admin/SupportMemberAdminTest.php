...
class SupportMemberAdminTest extends AbstractTestCase
{
    /**
...
//        ));
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/supportmember/list');
    ...
    public function testNew()
    {
        $this->logIn();
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/supportmember/create');
        $this->assertEquals(200, $client->getResponse()->getStatusCode());
