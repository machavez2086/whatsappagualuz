...
class LastAnswerKeywordAdminTest extends AbstractTestCase
{
     /**
...
//        ));
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/lastanswerkeyword/list');
    ...
    public function testNew()
    {
        $this->logIn();
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/lastanswerkeyword/create');
        $this->assertEquals(200, $client->getResponse()->getStatusCode());
