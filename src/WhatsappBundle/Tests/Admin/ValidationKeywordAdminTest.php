...
class ValidationKeywordAdminTest extends AbstractTestCase
{
    /**
...
//        ));
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/validationkeyword/list');
    ...
    public function testNew()
    {
        $this->logIn();
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/validationkeyword/create');
        $this->assertEquals(200, $client->getResponse()->getStatusCode());
