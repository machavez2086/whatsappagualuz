...
class FirstNoFollowKeywordAdminTest extends AbstractTestCase
{
    /**
...
//        ));
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/firstnofollowkeyword/list');
    ...
    public function testNew()
    {
        $this->logIn();
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/firstnofollowkeyword/create');
        $this->assertEquals(200, $client->getResponse()->getStatusCode());
