...
class TicketTypeAdminTest extends AbstractTestCase
{
    /**
...
//        ));
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/tickettype/list');
    ...
    public function testNew()
    {
        $this->logIn();
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/tickettype/create');
        $this->assertEquals(200, $client->getResponse()->getStatusCode());
