...
class WhatsappGroupAdminTest extends AbstractTestCase
{
   /**
...
//        ));
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/whatsappgroup/list');
    ...
    public function testNew()
    {
        $this->logIn();
        $client = $this->client;
        $client->request('GET', '/admin/whatsapp/whatsappgroup/create');
        $this->assertEquals(200, $client->getResponse()->getStatusCode());
